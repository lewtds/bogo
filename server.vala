...
public class InputContext : Object {
	...
	public bool process_key(uint keyval,
		...
		string to_commit = new_comp.substring(new_comp.index_of_nth_char(same_chars));
		debug(@"'$new_comp' '$composition' same: $same_chars backspaces: $backspaces to commit: $to_commit");
